...
public abstract class RSACipher {
	...
	public static String signByPublicKey(String data) throws Exception {
	 ...
	 //验证
	public static boolean verifyByPrivateKey(String data, String sign) throws Exception {
		String md5 = MD5Encode(data);
		String md5_2 = decryptByPrivateKey(sign);
	...
	public static boolean verify(String data, String sign, byte[] publicKeyBytes) throws Exception {
		String md5 = MD5Encode(data);
		String md5_2 = decryptByPublicKey(sign, publicKeyBytes);
		if (md5.equals(md5_2)) return true;
		return false;
	}
	...
	public static void main(String[] args) {
		try {
			setPublicKey("pcpf_publickey.der");
			setPrivateKey("pcpf_privatekey.der");

			String plainStr = "110511114506378000000000001S0C";
			...
			// 签名
			String hexSign = signByPublicKey(plainStr);
			...
			// 认证
			boolean f = verifyByPrivateKey(plainStr, hexSign);
			if (f) {
